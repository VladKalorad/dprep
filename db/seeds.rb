...
third_type = ['Сыр', 'Молочное и яйца', 'Заморозка', 'Овощи и зелень', 'Фрукты и ягоды','Мясо', 'Колбаса и сосиски', 'Рыба и морепродукты']
...
tenth_type = ['Мясные', 'Рыбные','Фруктовые', 'Паштеты', 'Овощные','Оливки и маслины', 'Фасоль', 'Горошек','Кукуруза', 'Грибы', 'Имбирь маринованный','Плов']
